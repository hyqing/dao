...
@EnableJpaRepositories(
        ...
        basePackages = {"org.example.dao.repository.tow"} // 设置dao所在位置
)
public class TowDateSourceConfig {
    // 配置数据源
    @Autowired
    @Qualifier("towDataSource")
    private DataSource towDataSource;
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean2(EntityManagerFactoryBuilder builder) {
        return builder
                ...
                .packages("org.example.dao.entity.tow")
    ...
    PlatformTransactionManager transactionManagerDatabase2(EntityManagerFactoryBuilder builder) {
        return new JpaTransactionManager(entityManagerFactoryBean2(builder).getObject());
    }
